...
On the left you can see a CT-scan image and on the right a mask (which refers to the location of the tumor) overlaid on top of a different image. Here, the mask indicates the position of the tumor.
